import { BAlert } from "../../constants/components";
import { dismissed, dismissCountDown } from "../../constants/events";
import {
  Boolean,
  PROP_TYPE_BOOLEAN_NUMBER_STRING,
  String,
} from "../../constants/props";
import { dismiss } from "../../constants/slots";
...
export const props = makePropsConfigurable(
  sortKeys({
    ...modelProps,
    dismissLabel: makeProp(String, "Close"),
    dismissible: makeProp(Boolean, false),
    fade: makeProp(Boolean, false),
    variant: makeProp(String, "info"),
  }),
  BAlert
);
...
export const BAlert = /*#__PURE__*/ extend({
  ...
  watch: {
    ...
    countDown(newValue) {
      ...
      if (isNumeric(show)) {
        this.$emit(dismissCountDown, newValue);
